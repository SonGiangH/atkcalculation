...
struct BuildForceController: View {
    ...
    var body: some View {
        HStack (spacing: 0) {
                        ...
                        HStack (alignment: .center, spacing: 0) {
                            Text("\(String(format: "%.2f",direction.buildForce))").frame(width: 110, height: 20).padding().background(Color.yellow).foregroundColor(.red).bold()
